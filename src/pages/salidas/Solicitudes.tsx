...
import { ClipboardList, PackageCheck, PackageMinus, X } from 'lucide-react'
  ...
  return (
    <>
      <PageHeader
        ...
        description="Lo que alguien pidió sacar del almacén. Se aprueba, y al entregarlo sale la nota y baja la existencia."
        actions={
          <Button icon={<PackageMinus />} onClick={() => setPidiendo(true)}>
            Pedir material
          </Button>
        }
      />
      ...
      <div className="space-y-3">
        {alaVista.map((s) => {
          ...
          const puedo = quePuedoHacerConLaSolicitud(s, comoActuo, alcanza('SALIDAS', 'ESCRITURA'))
